...
当前已运行时长：{hours_elapsed}h{minutes_elapsed}m{seconds_elapsed}s
预计剩余时间：{hours_remaining}h{minutes_remaining}m{seconds_remaining}s
预计完成时间：{formatted_completion_time}
-----
[Token用量]
